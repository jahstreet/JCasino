...
public class StreakManagerTest {
    ...
    public void buildRollStringCheck() {
        String actual = StreakManager.buildRollString(ROLL);
    ...
    public void buildBetStringCheck() {
        String actual = StreakManager.buildBetString(BET);
        Assert.assertEquals(String.format("Expected: %s\nActual: %s\n", BET_STRING, actual),
                            BET_STRING, actual);
    }
    ...
    public void buildLineString() {
        String actual = StreakManager.buildLineString(LINE);
        Assert.assertEquals(String.format("Expected: %s\nActual: %s\n", LINE_STRING, actual),
                            LINE_STRING, actual);
    }
    ...
    public void parseRollArrayCheck() {
        int[] actual = StreakManager.parseRollArray(ROLL_STRING);
    ...
    public void parseBetArrayCheck() {
        BigDecimal[] actual = StreakManager.parseBetArray(BET_STRING);
    ...
    public void parseLineArrayCheck() {
        boolean[] actual = StreakManager.parseLineArray(LINE_STRING);
    ...
    public void buildRollListCheck() {
        List<Roll> actual = StreakManager.buildRollList(ROLL_STRING, ROLL_STRING, LINE_STRING, BET_STRING, BET_STRING);
