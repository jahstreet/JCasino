...
/**
 * The class provides navigating to profile page for player.
 *
...
public class GotoPlayerProfileCommand implements Command {
    ...
    /**
     * <p>Provides navigating to profile page for player.
     * <p>Updates {@link by.sasnouskikh.jcasino.entity.bean.PlayerProfile} field's data of
     ...
     * {@link PageNavigator#FORWARD_PAGE_PROFILE}, else adds
    ...
    public PageNavigator execute(HttpServletRequest request) {
        ...
        try (PlayerService playerService = new PlayerService()) {
            if (playerService.updateProfileInfo(player)) {
