...
/**
 * The class provides navigating to answer support question page for admin.
 *
...
public class GotoAnswerSupportCommand implements Command {
    ...
    /**
     * <p>Provides navigating to answer support question page for admin.
     ...
     * to the Logic layer.
     * <p>If Logic operation passed successfully navigates to {@link PageNavigator#FORWARD_PAGE_ANSWER_SUPPORT}, else
