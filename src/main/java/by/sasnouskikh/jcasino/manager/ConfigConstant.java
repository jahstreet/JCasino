...
public class ConfigConstant {
    ...
    public static final String MESSAGE_INVALID_DATE              = "invalid.date.or.all";
    ...
    public static final String MESSAGE_TAKE_LOAN_NOT_ALLOWED      = "takeloan.notallowed";
    ...
    public static final String MESSAGE_WITHDRAWAL_NOT_ALLOWED     = "withdrawal.notallowed";
    ...
    public static final String MESSAGE_NULL_STREAK_COMPLETE_ERROR = "streak.complete.error.isnull";
    ...
    public static final String MESSAGE_GAME_NOT_ALLOWED           = "game.notallowed";
