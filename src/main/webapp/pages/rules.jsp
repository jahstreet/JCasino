    ...
    <section class="rules cols col-8">
        ...
        <div class="rules-table-container">
            <table class="reel-table rules-table">
                ...
                <jsp:useBean id="reeelValues" class="by.sasnouskikh.jcasino.game.ReelValues"/>
                <c:forEach var="index" begin="1" end="20" step="1">
                    <tr>
                        <td>${index}</td>
                        <td>
                            <fmt:message key="reel.value.${reeelValues.reelValues[index-1].toString().toLowerCase()}"/>
                        </td>
                        <td>${20+index}</td>
                        <td>
                            <fmt:message
                                    key="reel.value.${reeelValues.reelValues[20+index-1].toString().toLowerCase()}"/>
                        </td>
                        <td>${40+index}</td>
                        <td>
                            <fmt:message
                                    key="reel.value.${reeelValues.reelValues[40+index-1].toString().toLowerCase()}"/>
                        </td>
                    </tr>
                </c:forEach>
            </table>
