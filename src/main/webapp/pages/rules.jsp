...
<main class="container">
    ...
    <section class="rules cols col-8">
        ...
        <p>По окончании серии игр игроку становится доступно содержание секретной строки. Таким образом, игрок может
            проверить по окончании серии игр: правильность выпадения результатов, как по значениям ,так и по порядку их
            выпадения, также игрок может проверить идентичность показанной ему перед началом игры сигнатуры и той
            сигнатуры, которая будет получена им при повторном подписании секретной строки, ставшей ему доступной.
            Совпадение сигнатур однозначно свидетельствует о том, что в процессе игры игровые данные не менялись, игра
            велась честно, и ее результат полностью случаен.</p>
