...
<main class="container">
    ...
    <section class="manage-transactions cols col-8">
        ...
        <form class="custom-form clearfix" name="showTransactions" method="GET"
            ...
            <select name="type" title="<fmt:message key="manage.transactions.option.title"/>">
...
<script src="${pageContext.request.contextPath}/resources/js/manage_transaction.js"></script>